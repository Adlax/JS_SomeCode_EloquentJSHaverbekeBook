...
var legend2={"#":Wall,"O":SmartPlantEaterCritter,"*":Plant};
...
//SmartPlantEaterCritter////////////////////////////////////////////////////////
function SmartPlantEaterCritter(){
  this.energy=20;
  this.direction="e";
}

SmartPlantEaterCritter.prototype.act=function(view){
  var space=view.find(" ");
  if(this.energy>90 && space){returmn {type:"reproduce",direction:space};}
...
//Test final
var jungle=new LifeLikeWorld(plan2,legend2);
animateWorld(jungle,legend2);
