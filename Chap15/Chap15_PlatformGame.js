...
//Prototype et Constructeur de Level a partir d un plan//////////////////////////////////////
function Level(plan){
...
Level.prototype.playerTouched = function(type,actor){
	if(type == "lava" && this.status == null){
		...
		if(!this.actors.some(function(other) {return other.type == "coin";} )) {
			this.status = "win";
			this.finishDelay = 1;
		}
	}
...
//Constructeurs Actors ; Player, Coin, Lava/////////////////////////////////////
function Player(pos){
...
Lava.prototype.act = function(step,level){
	...
	else if(this.repeatPos) {this.pos = repeatPos;}
...
<link rel="stylesheet" href="Chap15_PlatformGame_CSS.js">
<script>
	var simpleLevel = new Level(simpleLevelPlan);
